...
def start_task():
    global signal_type_var, amplitude_var, phase_shift_var, analog_frequency_var, sampling_frequency_var
    global signal1_type_var, signal2_type_var, amplitude1_var, amplitude2_var, phase_shift1_var, phase_shift2_var
    global analog_frequency1_var, analog_frequency2_var, sampling_frequency1_var, sampling_frequency2_var
    global discrete_var
    ...
    signal_type_var = StringVar(root)
    amplitude_var = StringVar(root)
    phase_shift_var = StringVar(root)
    analog_frequency_var = StringVar(root)
    sampling_frequency_var = StringVar(root)
    signal1_type_var = StringVar(root)
    signal2_type_var = StringVar(root)
    amplitude1_var = StringVar(root)
    amplitude2_var = StringVar(root)
    phase_shift1_var = StringVar(root)
    phase_shift2_var = StringVar(root)
    analog_frequency1_var = StringVar(root)
    analog_frequency2_var = StringVar(root)
    sampling_frequency1_var = StringVar(root)
    sampling_frequency2_var = StringVar(root)
    discrete_var = BooleanVar(root)
    ...
    sampling_frequency1_var.set('10')
    ...
    sampling_frequency2_var.set('10')
